...
NSString *const kInfoAccessParameterIdCellID = @"InfoAccessParameterIdCellID";

@interface InfoAccessParameterIdCell ()
...
@implementation InfoAccessParameterIdCell
