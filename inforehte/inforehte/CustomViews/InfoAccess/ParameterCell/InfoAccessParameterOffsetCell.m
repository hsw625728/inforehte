//
//  InfoAccessParameterOffsetCell.m
//  inforehte
//
...
NSString *const kInfoAccessParameterOffsetCellID = @"InfoAccessParameterOffsetCellID";

@interface InfoAccessParameterOffsetCell ()
...
@implementation InfoAccessParameterOffsetCell
